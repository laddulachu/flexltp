...
function changeState(state, page, checkStateData) {
    ...
    var namespace = checkStateData.descriptor;
    if(checkStateData.event) {
        var action = "on_" + checkStateData.event;
    ...
    } else if(checkStateData.screens) {
...
exports.checkState = function (page, data) {
    page.checkStateUsingDescriptor()
        .then(function (checkStateData) {
            try {
                var state = checkStateData.connection;
